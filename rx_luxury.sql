...
-- Thời gian đã tạo: Th12 14, 2024 lúc 11:09 PM
...
-- Thủ tục
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `reset_password` (IN `p_email` VARCHAR(255), IN `p_reset_token` VARCHAR(255))   BEGIN
    UPDATE `nguoi_dung`
