...
import './asests/css/rolex.css'; // Đảm bảo đường dẫn đúng với vị trí file CSS
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                // Lọc chỉ các sản phẩm có tên chứa "Rolex"
                const filteredProducts = data.filter(product =>
                    product.ten_san_pham.toLowerCase().includes("rolex")
                );
