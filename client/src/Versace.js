...
import './asests/css/versace.css'; // Đảm bảo đường dẫn đúng với vị trí file CSS
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                // Lọc chỉ các sản phẩm có tên chứa "Versace"
                const filteredProducts = data.filter(product =>
                    product.ten_san_pham.toLowerCase().includes("versace")
                );
